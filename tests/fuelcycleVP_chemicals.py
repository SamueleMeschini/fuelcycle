...
from cryopumpSystem_chemicals import CryopumpSystem
...
partial_pressure = 1 #Pa (except He, will be subscribed)
...
CS.species["Helium"].partial_pressure = partial_pressure*f_HeT_div
